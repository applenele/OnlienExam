...
$(document).ready(function(){
	...
	var xyNode=$("#xyId");
	var majorNode=$("#majorId");
	var bjNode=$("#classId");
	
	var suserName=suserNameNode.val();
	var xyIdString=xyNode.val();
	var majorIdString=majorNode.val();
	var bjString=bjNode.val();
	
    var xyId=parseInt(xyIdString);
    var majorId=parseInt(majorIdString);
    var classId=parseInt(bjString);
	...
	$("#next").click(function(){
		...
		$.ajax({
			type:"post",
			url:"getSearchResultPage",
			dataType:"json",
			cache:false,
			data:{
				 "pageIndex":nextPageIndex,
		         "studentOfsearchInfo.xyId":xyId,
		         "studentOfsearchInfo.majorId":majorId,
		         "studentOfsearchInfo.classId":classId
			},
			success:function(data){
				if(data=="["){
				 ...
				 var tds="<thead><tr><th>编号</th><th>学生姓名</th><th>学号</th><th>学院</th><th>专业</th><th>班级</th><th>性别</th><th>邮箱</th><th>操作</th></tr></thead>";
